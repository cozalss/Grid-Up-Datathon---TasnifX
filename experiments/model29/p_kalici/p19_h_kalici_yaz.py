...
PK = (
    r"c:/Users/Cem/Desktop/Datahon_Laptop/Grid-Up-Datathon---TasnifX"
...
def kz(a, b):
    ...
    return dict(
        ...
        pg=v["pg"],
        bil=v["bilesim_agr"],
        oy_agr=v["onyukleme_agr"]["pozitif_oran"],
...
d["01_ENVANTER"] = {
    ...
    "TABAN_dogrulama": (
        "p19_a --aday TABAN uretim npz'si ile BIREBIR: yaz25 t1000, yaz25 t1001, "
        "guz25 t1000, kis26 t1000 -> maxabs = 0.000e+00. TEZGAH GECERLI."
    ),
    "TABAN_tamamlama": (
        "yaz25 t1002, guz25 t1001/1002, kis26 t1001/1002 icin TABAN yeniden "
    ...
    "coken_adaylar": (
        "yaz25'te hp_l2r10 / hp_rs4 / hp_lr03_it400 CatBoostError 'bad allocation', "
    ...
    "tau_izgarasi": (
        "OLCULMEDI. On-kayittaki TAU_YAPISAL_UYARI tau'nun soguk tarafta yaz25 icin "
...
d["02_TAM_TABLO_uretim_olcutu_cat_tekil"] = {
    "olcut": (
        "kohort-agirlikli soguk RMSLE kazanci, pozitif = TABAN'dan IYI. "
...
d["03_HUKUM_soguk_cat"] = {
    ...
    "CEVAP": (
        "KAYIP FONKSIYONU tarafinda YOK. HIPERPARAMETRE tarafinda tek sartli aday: depth=8. "
    ...
    "kayip_fonksiyonlari_KAPANDI": {
        ...
        "desen": (
            "HEPSI yaz25'te belirgin NEGATIF (agr -0.016 .. -0.113). kis26'da pozitif "
        ...
        "blok_disi_kanit": (
            "yaz25 hedefinde dis iki blok huber_a40'i seciyor -> yaz25'te -0.0155 agr, "
            "onyukleme P(+)=0.356. Durust secim KAYBEDIYOR."
        ),
        "yaz25_neden_onemli": (
            "Test donemi 2026-04..07; yaz25 = 2025-04..07 teste MEVSIMSEL olarak "
    ...
    "hp_derin8_TEK_HAYATTA_KALAN": {
        ...
        "seviye": {
            b: dict(
                TABAN=B["bloklar"][b]["aday_seviye"]["TABAN"],
                derin8=B["bloklar"][b]["aday_seviye"]["hp_derin8"],
            )
            for b in BLOK
        },
        "KAPILAR": {
            ...
            "d_tohum_1->3": (
                "yaz25 +0.0498 -> +0.0397 AYAKTA (3/3 tohum pozitif); "
                "guz25 +0.0191 -> +0.0086 ZAYIFLADI (t1001 -0.0019, 2/3); "
                "kis26 3/3 tohum NEGATIF"
            ),
            "e_onyukleme": (
                "yaz25 P(+)=1.000 GA95 [+0.027,+0.065] GECTI; "
                "guz25 P(+)=0.800 GA95 [-0.010,+0.026] GECMEDI; kis26 P(+)=0.044 TERS"
            ),
        },
        "hukum": (
            "SARTLI KAZANC. a,b,c gecti; e yalniz yaz25'te gecti. LEHTE: tek net blok yaz25 -- "
    ...
    "digerleri": {
        ...
        "hp_bt10": (
            "bagging_temperature=1.0 yaz25'te TABAN ile BIREBIR AYNI (agr farki 0.00000) -- "
...
d["04_SORU5_311_harmaninda_lgbm_huber"] = {
    "SORU": (
        "p20/p21 adayi soguk harmani 3/1/1'e (cat 0.6 / xgb 0.2 / lgbm 0.2) donduruyor. "
        "lgbm uyesini HUBER yapmak bilesik soguk RMSLE'yi ne yapar?"
    ),
    "yontem": (
        "EGITIM YOK. B = 0.6*cat + 0.2*xgb + 0.2*lgbm(L2) vs C1 = ayni ama lgbm HUBER. "
    ...
    "denetim": (
        "p11b_{blok}_{tohum}_TABAN.npy npz'nin '{tohum}_lgbm' anahtariyla birebir mi diye "
    ...
    "blok_detay": {
        ...
        for a, bb in E["kazanclar"].items()
    },
    "CEVAP": (
        "KISMEN GERI GELIYOR, AMA YETERSIZ. 3/1/1'de lgbm payi 0.2 (esit harmanda 1/3 idi), "
...
d["05_EK_KESIF_311_uye_degisimleri"] = {
    ...
    "blok_detay": {
        ...
        for k, bb in F["kazanclar"].items()
    },
    "C3_UYARISI": (
        "C3'un 3/3 blokta pozitif gorunmesi DORT YAPI ARASINDAN TAM VERIYLE SECILDI. "
    ...
    "HUKUM": (
        "Her hedef blok icin secim YALNIZ dis iki bloga bakilarak yapilinca bilesim kazanci "
...
d["06_NET_HUKUM"] = {
    "1": (
        "SOGUK CAT'TA URETIM TABANINI GECEN BIR KAYIP FONKSIYONU YOKTUR. huber (5 alfa), MAE, "
        "Quantile(0.5), MAPE olculdu; hepsi teste mevsimsel denk gelen yaz25 blogunda belirgin "
        "kaybettiriyor. YOL KAPANDI."
    ),
    "2": (
        "Hiperparametre tarafinda depth=8 SARTLI bir kazanctir: cat-tekil olcutte yaz25 +0.0397 agr "
    ...
    "3": (
        "ANCAK URETIM ARTIK CAT-TEKIL DEGIL. p20/p21 adayi soguk harmani 3/1/1 yapiyor, cat payi 0.6. "
        "depth=8'in 3/1/1 ICINDE olculmus etkisi: yaz25 +0.0064, guz25 +0.0004, kis26 -0.0052, "
        "ORT +0.0005 -- PRATIKTE SIFIR."
    ),
    "4": (
        "Soru 5: 3/1/1'de lgbm->huber GERI GELIYOR ama kucuk (ort +0.0037 a=1.0 / +0.0060 a=0.5, "
        "2/3 blok, yaz25 NEGATIF). Dort yapi uzerinde durust blok-disi secimle ort +0.00215."
    ),
    "5": (
        "KAMPANYA KAPANIYOR. p19'dan gonderime girecek bir degisiklik CIKMADI. "
        "p20/p21 adayi (p20_harman_ESKI_3_1_1_V1_seviyesiz.csv) oldugu gibi kalir."
    ),
    "tek_sart": (
        "Baska hicbir sey bulunamaz ve 3. gonderim hakki bosta kalirsa 3/1/1 + lgbm-huber(a=0.5) "
...
d["07_URETILEN_DOSYALAR"] = {
    "scratchpad_json": [
        ...
        "p19_c_harman.json",
        "p19_d_kirmizi.json",
        "p19_e_311_lgbm_huber.json",
        "p19_f_311_bilesim.json",
        "p19_g_blokdisi.json",
    ],
    ...
    "p_kalici_betikler": [
        ...
        "p19_c_harman.py",
        "p19_d_kirmizi.py",
        "p19_e_311_lgbm_huber.py",
        "p19_f_311_bilesim.py",
        "p19_g_blokdisi.py",
    ],
    "YASAK_UYULDU": (
        "Test tahmini uretilmedi, Kaggle gonderimi yapilmadi, submissions/ altina "
