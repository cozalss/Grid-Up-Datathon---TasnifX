...
m = bf
for et, dosya, kol in (("p02_v1_karisim", "p02_yaz25.parquet", "p_kar"),
...
for c in ["p02_v1_karisim", "p02_v4"]:
    best = min(((np.sqrt(((w2 * m[c] + (1 - w2) * m.mevcut - y) ** 2).mean())), w2)
...
R["_not"] = ("yaz25=2025-04-01..07-31, 274929 satir, 2891 trafo, %7.5 soguk. "
