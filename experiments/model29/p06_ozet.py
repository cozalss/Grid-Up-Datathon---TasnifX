...
def main():
    ...
    R = {
        ...
        "SONUC": {
            ...
            "onyukleme": {"ort": 0.02312, "std": 0.01086, "ci95": [0.00282, 0.04423], "pozitif_oran": 0.984},
        ...
        "olculen_fikirler": {
            ...
            "6_soguga_ozel_sifir_siniflandirici": {
                ...
                "gerekce": "Soguk satirlarda sifirlar satirlarin %4'u ama KARE HATANIN %57,3'u "
                           ...
                           "(yani 'duzeltme yapma').",
                "olcum": Q and {k: Q.get(k) for k in ("auc_yaz25_soguk", "ic_secim", "duzeltme", "SECILEN")},
            },
        },
        "hata_anatomisi_soguk": A and {k: A.get(k) for k in ("sifir_kesiti", "tavanlar_sizintili", "trafo_sapmasi")},
        "aile_olcumleri": {"blok_bazli": F, "sicak_karsilastirmasi": F2, "agirlik_izgarasi": W},
        "test_ciktisi": Te,
        "betikler": [
            "p06_soguk_tani.py", "p06_soguk_anatomi.py", "p06_soguk_sifir.py",
            "p06_soguk_pencere.py", "p06_soguk_q.py", "p06_soguk_dogal.py",
            "p06_soguk_rampa.py", "p06_soguk_yeniden.py", "p06_soguk_aile.py",
            "p06_soguk_aile2.py", "p06_soguk_agirlik.py", "p06_soguk_afin.py",
            "p06_soguk_test.py", "p06_ozet.py",
        ],
        "sizinti_denetimi": [
