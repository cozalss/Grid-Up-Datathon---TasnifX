...
ozet = {
 ...
 "gereken_esik": {"gorevdeki_esik": 0.006,
 ...
 "TESHIS": {
  ...
  "3_neden_carpan_kaybettiriyor": {
   ...
   "uretim_sifir_satirda_ortalama_tahmin": tes["bloklar"]["yaz25"]["sifir_satirda_ortalama_tahmin"],
 ...
 "betikler": ["p05_uretim_iki_asama.py", "p05_ikiz_sinav.py",
              "p05_sifir_tavani.py", "p05_teshis.py",
...
ana["OZET"] = ozet
json.dump(ana, io.open(os.path.join(B, "p05_uretim_iki_asama.json"), "w",
