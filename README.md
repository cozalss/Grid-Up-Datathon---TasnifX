...
| **30 Ağu – 1 Eyl planı** | **9 hak = 8 eksen ölçümü + 1 saf optimum.** Sıra `y40 z2 sul` / `y46 y45 q1c` / `t3 p42 NİHAİ`. Sürücü: `python experiments/model29/m108_gun.py --baslat`, sonra her skor için `--skor <S>`. **Dürüst beklenti: medyan `1,00056` (3. sıra güvende), 2. sıra (`0,99940`) için yön başına `rho ≈ 0,0224` gerek — dürüst önsel ortancası `0,0146`.** İyimser önselde `0,99869`. **Geriye gitme riski %0.** Ayrıntı ve gerekçe: [`docs/62`](docs/62-TAM-TARAMA-ve-DONMUS-PLAN.md) |
