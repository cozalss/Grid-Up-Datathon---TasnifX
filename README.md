...
| | |
|---|---|
| **Liderlik Tablosu** | **4. Sıra (TasnifX)**: `1.00553` · **1.** Grid Grinders `0.99064` · **2.** Atakan Aldemir `1.00041` · **3.** Şaban Özdoğan `1.00543` · **5.** Ahmet Çelik `1.00559` — 3.–5. sıra 0,00016 içinde. Eşikler: 2. için `−0,0051`, 1. için `−0,0149` (2026-08-28 akşamı) |
...
| **29 Ağustos planı** | **HAK 1**: `submissions/tuketim_m4_hava_capali.csv` — ileri-pencere doğrudan tahmin + hava/dış veri (133 öznitelik, Huber+L1, 3'er tohum). `Q = 0,121581`, **başabaş `1,06427`**<br>**HAK 2**: `python experiments/model29/m50_harman_coz.py tuketim_m4_hava_capali.csv <HAK1 skoru>`<br>**HAK 3**: yedek üçüncü yön `tuketim_m3_hl1_capali.csv`<br>`S=0,99 → 0,98144` (1.) · `S=1,00553 → 0,99030` (2.) · `S=1,02 → 0,99679` (2.)<br>Ayrıntı: [`docs/53`](docs/53-yeni-model-ve-29-agustos-plani-2026-08-28.md) |
