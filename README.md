...
| **30 Ağustos planı** | **HAK1** `tuketim_g7_span_tau3.csv` (span optimumu, öngörü `1.00137±0.00007`) · **HAK2** `tuketim_y46_amnezik_kirpik.csv` (yeni yönü ölç: Q=0,388 kurtoz=4,5) · **HAK3** `m99_coklu_coz.py` ile ortak optimum. Kılavuz: [`docs/57`](docs/57-30-agustos-kosu-kilavuzu.md) |
