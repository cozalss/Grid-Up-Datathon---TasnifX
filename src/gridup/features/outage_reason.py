...
REASON_FAMILIES: tuple[tuple[str, int, bool, tuple[str, ...]], ...] = (
    ...
    ("HAVA",         1, True,  ("olumsuz hava", "hava sart", "elverissiz hava",
                                "hava kosul", "firtina", "yildirim",
                                "kar ", "buzlanma", "sel ", "dolu ", "ruzgar")),
    ("AGAC",         2, True,  ("agac", "dal ", "bitki", "orman")),
    ("HAYVAN",       3, True,  ("kus ", "hayvan", "kedi", "leylek", "yilan")),
    ("UCUNCU_SAHIS", 4, True,  ("3.sahis", "3. sahis", "ucuncu sahis", "kazi",
                                "arac carpma", "is makinesi", "vinc", "hasar",
                                "yabanci cisim")),
    ...
    ("IDARI_KESME", 22, False, ("borctan kesme", "yikimdan kesme", "kacak",
                                "usulsuz", "tahsilat")),
    ("EMNIYET",     23, False, ("emniyet", "can ve mal", "guvenlik",
                                "tehlike onleyici", "tedbir amacli")),
    ("MANEVRA",     20, False, ("manevra", "scada", "sebeke calis", "planli",
                                "bakim", "yatirim", "yeni baglanti", "revizyon",
                                "kolon islem", "deplase", "dahili onarim",
                                "veri duzeltme", "kesinti talep")),
    ("TALEP",       21, False, ("abone talep", "musteri talep", "resmi kurum")),
    # --- Sebeke ici mekanizmalar ---
    ("ASIRI_YUK",    5, True,  ("asiri yuk", "yuklenme", "overload", "asiri akim",
                                "termik ac", "asiri akim toprak")),
    ("KABLO",        6, True,  ("kablo", "iletken", "hat kop", "kop", "havai hat",
                                "jumper", "rekortmen", "rekortman", "notr ariza")),
    ("TRAFO",        7, True,  ("trafo", "transformator", "guc trafo")),
    ("SIGORTA",      8, True,  ("sigorta", "nh sigorta")),
    ("KESICI",       9, True,  ("kesici", "ayirici", "rekloser", "fider ac",
                                "tms", "salter", "kontaktor", "sekonder koruma")),
    ...
    ("EKONOMIK_OMUR", 13, True, ("ekonomik omur", "yaslanma", "eskime",
                                 "korozyon", "asinma")),
    # --- Genel sebeke arizasi: spesifik ekipman belirtilmemis ---
    ("SEBEKE",      16, True,  ("og ariza", "ag ariza", "og-ariza", "ag-ariza",
                                "sebeke ariza", "aydinlatma")),
    # --- Siniflandirilamayanlar ---
    ("GECICI",      30, True,  ("gecici", "transient", "otomatik tekrar")),
    ("BILINMEYEN",  99, True,  ("bilinmeyen", "belirsiz", "tespit edilemedi",
                                "girilmemis", "girilmemistir")),
)
