"""HARMAN AGIRLIGI -- uc tohumla, uretim yapilandirmasinda.
...
def main() -> int:
    ...
    for kol_ad, kaynak, ayikla in (("EK KOKENLI", genis, True),):
        for b in tm.BLOKLAR:
    ...
    for i, aile in enumerate(AILELER):
        ...
        a = e = skor("EK KOKENLI", w)  # type: ignore[arg-type]
